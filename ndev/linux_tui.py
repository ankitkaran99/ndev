...
from ndev.runtime.pma import get_pma_status, start_pma, stop_pma, restart_pma, setup_pma
from ndev.runtime.mailpit import get_mailpit_status, start_mailpit, stop_mailpit, restart_mailpit, is_installed as is_mailpit_installed, setup_mailpit
from ndev.runtime import upgrade as upgrade_core
...
class NdevDashboard(App):
    ...
    async def _create_vhost_worker(self, domain: str, root: str, php_ver: str, ssl: bool) -> None:
        ...
        def _do() -> str:
            from ndev.commands.vhost import generate_local_cert, chown_to_sudo_user
